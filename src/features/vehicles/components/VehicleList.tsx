    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center rounded-2xl border-2 border-dashed border-gray-300 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          ...
          <Link 
            href="/documents"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-zinc-800 border-2 border-gray-300 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 font-medium rounded-lg transition-colors"
          >
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-3">
          <Link 
            href="/documents"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 font-medium rounded-lg transition-colors"
          >
            <span className="hidden sm:inline">{t('registerDocuments')}</span>
